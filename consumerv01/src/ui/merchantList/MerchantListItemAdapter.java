...
public class MerchantListItemAdapter extends ArrayAdapter<String>{

	private final Context context;
	private final String[] Ids;
	private final int rowResourceId;

	public MerchantListItemAdapter(Context context, int textViewResourceId,
			String[] objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DisplayListItem item = MerchantListModelAdapter.GetbyId(id);
